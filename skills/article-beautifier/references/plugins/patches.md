...
Do not register patches speculatively; each one is a maintained fork of a dependency in your lockfile. See the maintainer patch strategy (`docs/maintainers/patches.md`).
