...
> **Historical record — not authoritative for current architecture.** The migration
> described here has been executed; current facts live in
> [architecture](../concepts/architecture.md) and [project status](../maintainers/project-status.md).
