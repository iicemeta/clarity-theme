...
**English** | [简体中文](./2026-09-config-api-audit.zh-CN.md)

> **Historical audit snapshot — no longer authoritative for current status.**
> Current configuration facts live in [configuration](../guides/configuration.md),
> [API](../reference/api.md), and [PROJECT-STATUS](../maintainers/project-status.md). The verification
