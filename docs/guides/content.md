...
The verified feature matrix is generated in [compatibility](../reference/compatibility.md). Author-facing syntax, per-component references, and the capability audit live in the authoring corpus ([Markdown / MDC reference](../_content/mdc/README.md), content-creation material rather than Theme documentation). To customize rendering output, prefer component and Shiki overrides as described in [customization](./customization.md).
