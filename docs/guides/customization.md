...
See [Configuration](../guides/configuration.md) for the data contract and [Migration](../getting-started/migration-from-blog-v3.md) for blog-v3 file mapping.

## 1. UI configuration

Create `app/app.config.ts` and place overrides under the flat upstream-shaped keys:
...
Then run your project's own integration and deployment tests. See [Migration → Validation](../getting-started/migration-from-blog-v3.md#7-validation) for the full checklist.
